...
provider "github" {
  # Configuration options
  token = "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"
}

resource "github_repository" "myrepo" {
  name = "bookstore-docker-project"
  auto_init = true
  visibility = "private"
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
          ...
          TOKEN="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"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/toptasc/bookstore-docker-project/main/"
          ...
          docker build -t toptasc/webserver13:latest .
          docker-compose up -d
          EOF
...
resource "aws_security_group" "tf-docker-sec-gr" {
  name = "docker-sec-gr-203-${var.tag}"
  tags = {
